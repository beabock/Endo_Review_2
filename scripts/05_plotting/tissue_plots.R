...
# Tissue Co-occurrence Network (shared tissues in papers)
...
# Tissue Data Completeness (Sankey-style waterfall)
...
# Tissue by Biome (Faceted bar chart)
tissue_biome <- df %>%
	transmute(
		paper_id = as.character(paper_id),
...
# Tissue Richness per Study (Distribution)
...
# Cumulative Coverage Curve (Ranked coverage threshold)
