...
#
# ARCHIVED 2026-08-27 (NPH-MS-2026-57711 resubmission): GDP / "Prediction 4" was cut
# from the manuscript on all three referees' advice. This script is kept for a possible
# future socioeconomic side-project and is NOT part of the main analysis path. The
# latitude half now lives in scripts/04_analyses/01_country_latitude_analysis.R.
#
# To run this: first regenerate the enriched country table WITH GDP columns:
#   Rscript scripts/03_standardize_metadata/04_country_enrichment.R --with-gdp
# (the default pipeline run omits GDP). Then run this script.
